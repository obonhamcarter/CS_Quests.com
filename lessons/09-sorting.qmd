...
- 📓 **<a href="../jupyterlite/lab/index.html?path=lessons/09-sorting.ipynb" target="_blank">Open in JupyterLite</a>** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **<a href="../files/lessons/09-sorting.ipynb" target="_blank">Download Notebook</a>** - For use in local Jupyter or Google Colab
:::
...
print("\n💡 Notice how the number of operations changes!")
```
...
::: {.tip-box}
**📱 Fantastic!** Understanding sorting helps you organize data efficiently! 🗂️
:::
