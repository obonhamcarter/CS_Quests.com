...
::: {.quest-badge}
✨ QUEST 15 | Difficulty: Intermediate | Time: 5 minutes
:::
::: {.concept-box}
...
- 📓 **<a href="../jupyterlite/lab/index.html?path=lessons/15-functions-returning.ipynb" target="_blank">Open in JupyterLite</a>** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **<a href="../files/lessons/15-functions-returning.ipynb" target="_blank">Download Notebook</a>** - For use in local Jupyter or Google Colab
:::

## 📖 Introduction: The Pure Spellcaster
...
::: {.story-box}
**🧙‍♂️ Story Time**: You're training with the Grand Mage who teaches you "Pure Spells" — spells that take certain ingredients and always produce the same result. No randomness, no side effects, just pure calculation. The more you master these, the more powerful your code becomes!
:::

## 💡 Explanation: Pure Functions & Return Values
...
- ✅ Testable: Easy to test since no hidden dependencies
- ✅ Reusable: Works anywhere without side effects
- ✅ Debuggable: If it fails, you know it's the inputs
...
## 🎮 Activity 1: Math & Calculation Functions
...
## 🎮 Activity 3: Data Processing Functions
...
## 🧩 Challenge: Implement Game Math Functions
