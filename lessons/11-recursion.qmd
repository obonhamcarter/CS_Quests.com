...
- 📓 **<a href="../jupyterlite/lab/index.html?path=lessons/11-recursion.ipynb" target="_blank">Open in JupyterLite</a>** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **<a href="../files/lessons/11-recursion.ipynb" target="_blank">Download Notebook</a>** - For use in local Jupyter or Google Colab
:::
...
def visual_countdown(n, indent=0):
    ...
    # Base case
    if n <= 0:
        print(f"{spaces}🚀 LIFTOFF!")
        return
    
    # Show entering this level
    print(f"{spaces}➡️ Entering countdown({n})")
    ...
    print(f"{spaces}⬅️ Returning from countdown({n})")
