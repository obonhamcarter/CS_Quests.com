...
- 📓 **<a href="../jupyterlite/lab/index.html?path=lessons/07-dictionaries.ipynb" target="_blank">Open in JupyterLite</a>** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **<a href="../files/lessons/07-dictionaries.ipynb" target="_blank">Download Notebook</a>** - For use in local Jupyter or Google Colab
:::
...
# Access nested data
print(f"\n🧙 The mage's intelligence is: {party['mage']['stats']['intelligence']}")
```
