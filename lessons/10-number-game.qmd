...
- 📓 **<a href="../jupyterlite/lab/index.html?path=lessons/10-number-game.ipynb" target="_blank">Open in JupyterLite</a>** - Full Jupyter environment in your browser
- ▶️ **Run code directly below** - All code cells on this page are editable and runnable
- 📥 **<a href="../files/lessons/10-number-game.ipynb" target="_blank">Download Notebook</a>** - For use in local Jupyter or Google Colab
:::
...
- Attempts: ~log₂(100) ≈ 7 attempts maximum!
- Works by eliminating half the possibilities each time

**Example for secret = 87**:
1. Guess 50 → Too low, search [51-100]
2. Guess 75 → Too low, search [76-100]
3. Guess 87 → FOUND! (or search [88-100] if too high)
...
- 100 → 50 → 25 → 12 → 6 → 3 → 1
- That's roughly log₂(100) ≈ 6.64 ≈ 7 guesses
