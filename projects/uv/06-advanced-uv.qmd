...
- 📓 **[Open in JupyterLite](../../jupyterlite/lab/index.html?path=projects/uv/06-advanced-uv.ipynb)** - Full Jupyter environment in your browser
...
- [Kaggle Datasets](https://www.kaggle.com/datasets) - Millions of datasets
...
::: {.navigation-box}
**Previous**: [1.5 Real-World Project](05-complete-project.qmd) | **Next Chapter**: [Pygame - Build Games!](../../projects/pygame/01-intro-pygame.qmd)
:::
