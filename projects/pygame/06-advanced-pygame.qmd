...
- 📓 **<a href="../../jupyterlite/lab/index.html?path=projects/pygame/06-advanced-pygame.ipynb" target="_blank">Open in JupyterLite</a>**
- 📥 **<a href="../../files/projects/pygame/06-advanced-pygame.ipynb" target="_blank">Download Notebook (Challenge)</a>** - For use in local Jupyter or Google Colab
...
::: {.navigation-box}
**Previous**: <a href="05-space-invaders.qmd" target="_blank">2.5 Space Invaders</a> | **Next Chapter**: <a href="../../projects/manim/01-intro-manim.qmd" target="_blank">Manim - Math Animations!</a>
:::
