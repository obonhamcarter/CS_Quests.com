...
- 📓 **<a href="../../jupyterlite/lab/index.html?path=projects/pygame/01-intro-pygame.ipynb" target="_blank">Open in JupyterLite</a>** - Full Jupyter environment in your browser
- 📥 **<a href="../../files/projects/pygame/01-intro-pygame.ipynb" target="_blank">Download Notebook (Challenge)</a>** - For use in local Jupyter or Google Colab
...
::: {.navigation-box}
**Next**: <a href="02-setup-pygame.qmd" target="_blank">2.2 Setting Up Pygame & First Window</a>
:::
